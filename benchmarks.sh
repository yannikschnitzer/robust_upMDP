...
python3 run.py --sg_itt 2500 --init_step 1000 --model sav --inst 2,6,2,2 -vo --file_out sav_2622.txt --tol 1e-4 --save_res sav_2622_res.txt -N 20 --to 3600 --MC --MC_p --sg_only --MC_samples 10
