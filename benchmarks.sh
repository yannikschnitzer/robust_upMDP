...
python run.py --sg_itt 250 --init_step 1000 --model sav --inst 2,6,2,2 -vo --file_out sav_2622.txt --tol 1e-4 --save_res sav_2622_res.txt -N 200 --to 36000 --MC --MC_p
python run.py --sg_itt 250 --init_step 1000 --model sav --inst 2,100,10,10 -vo --file_out sav_21001010.txt --tol 1e-4 --save_res sav_21001010_res.txt -N 200 --to 3600 --MC --MC_p
python run.py --sg_itt 250 --init_step 1000 --model sav --inst 4,6,2,2 -vo --file_out sav_3622.txt --tol 1e-4 --save_res sav_4622_res.txt -N 200 --to 36000 --MC --MC_p
python run.py --sg_itt 250 --init_step 1000 --model sav --inst 4,10,3,3 -vo --file_out sav_41033.txt --tol 1e-4 --save_res sav_41033_res.txt -N 200 --to 3600 --MC --MC_p
